...
const schema = z.object({
  content: z
    ...
    .max(domainConsts.MAX_POST_CONTENT_LENGTH, `${domainConsts.MAX_POST_CONTENT_LENGTH}文字以下で入力してください。`),
});
...
const usePostModal = () => {
  ...
  useEffect(() => {
    ...
    setProgress(
      currentContent === undefined ? 0 : (currentContent.length / domainConsts.MAX_POST_CONTENT_LENGTH) * 100
    );
